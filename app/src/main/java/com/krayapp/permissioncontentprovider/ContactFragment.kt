...
import com.krayapp.permissioncontentprovider.databinding.ContactFragmentBinding
...
class ContactFragment : Fragment() {
            ...
            REQUEST_CODE -> {
                if ((grantResults.isNotEmpty() &&
                    ...
                    context?.let {
                        AlertDialog.Builder(it)
                            .setTitle("Доступ к контактам")
                            .setMessage("Без этого разрешения не получится показать контакты>")
    ...
    private fun addView(context: Context, textToShow: String) {
        binding.contactContainer.addView(AppCompatTextView(context).apply {
            text = textToShow
